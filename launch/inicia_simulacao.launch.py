...
def generate_launch_description():
    ...
    # Encontra o diretório de instalação do pacote 'missao_bandeira'.
    pkg_share = FindPackageShare("missao_bandeira").find("missao_bandeira")  #  Alterado para `missao_bandeira` (antigo prm2026)
